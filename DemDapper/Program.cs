...
var connectStr = "Data Source=DESKTOP-LUI2B4C\\MSSQLSERVER01;Initial Catalog=eShop;Integrated Security=True";

var da = new DataAccess(connectStr);

var result1 = da.Query<Product, dynamic>("select * from product", new { });
var result2 = da.QuerySingle<Product, dynamic>("select * from product where ProductId=@ProductId", new { Id = 379 });
